package com.codingrecipe.board_spring_boot.controller;

import com.codingrecipe.board_spring_boot.dto.BoardDTO;
import com.codingrecipe.board_spring_boot.service.BoardService;
...
public class BoardController {
    ...
    @GetMapping("/")
    public String findAll(Model model) {     //DB에서 가져올땐 Model사용??아마
